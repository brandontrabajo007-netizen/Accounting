...
exports.PendingEventMongoModel = void 0;
...
const PendingEventSchema = new mongoose_1.Schema({
    ...
    interpretedData: { type: mongoose_1.Schema.Types.Mixed, required: true },
...
exports.PendingEventMongoModel = mongoose_1.default.models.PendingEvent ?? mongoose_1.default.model('PendingEvent', PendingEventSchema);
