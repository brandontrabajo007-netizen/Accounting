...
exports.pdfkitReportPdfGenerator = void 0;
...
// TABLA DE SECCIÓN
// ─────────────────────────────────────────────────────
const drawSectionTable = (doc, section, opts) => {
    const rowHeight = 20;
...
// GENERADOR PDF
// ─────────────────────────────────────────────────────
const pdfkitReportPdfGenerator = () => ({
    async generateIncomeStatement(model) {
...
exports.pdfkitReportPdfGenerator = pdfkitReportPdfGenerator;
